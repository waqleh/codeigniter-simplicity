...
class MY_Loader extends CI_Loader {
    ...
    function css() {
        ...
        foreach ($css_files as $css_file) {
            //example //netdna.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css
            if (preg_match("/^\/\//", trim($css_file)) < 0) {
            ...
            if (is_bool($css_file))
                continue;
            //                                                              example //netdna.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css
            $is_external = preg_match("/^https?:\/\//", trim($css_file)) || preg_match("/^\/\//", trim($css_file)) ? true : false;
    ...
    function js() {
        ...
        foreach ($script_files as $script_file) {
            if (preg_match("/^\/\//", trim($script_file)) < 0) {
            ...
            $is_external = preg_match("/^https?:\/\//", trim($script_file)) || preg_match("/^\/\//", trim($script_file)) ? true : false;
